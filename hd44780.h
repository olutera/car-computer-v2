...
void lcd_cgram_write(const char * array8,uint8_t addr); /* store LCD CHAR to cgram,edit Luta */
...
*
*/
//extern void rolltext_lcd_p(const char *text, int shiftlen);
...
*/
extern int lcd_putc_stream(char c, FILE *stream);
